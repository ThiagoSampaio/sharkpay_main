    ...
    <head>
        ...
        <style>
          ...
          .auth-home-link {
            ...
            box-shadow: 0 12px 28px rgba(28, 35, 64, 0.08);
            color: #291d56;
            font-size: .88rem;
            font-weight: 800;
            letter-spacing: .04em;
          ...
          .auth-home-link:hover {
            ...
            border-color: rgba(245, 138, 0, 0.28);
            background: rgba(255, 255, 255, 0.92);
            box-shadow: 0 16px 34px rgba(123, 22, 244, 0.12);
          }
          ...
          .auth-home-link__icon {
            ...
            background: linear-gradient(135deg, #efe6ff 0%, #fff2df 100%);
            color: #7b16f4;
            flex: 0 0 auto;
          }
...
<!-- header begin-->
  <body class="bg-secondary">
    <nav id="navbar-main" class="navbar navbar-horizontal navbar-transparent navbar-main navbar-expand-lg navbar-dark auth-topbar">
      <div class="container auth-topbar-inner">
      @if (Auth::guard('user')->check()) 
        <a class="auth-home-link" href="{{route('user.logout')}}">
          <span class="auth-home-link__icon"><i class="fas fa-sign-out-alt"></i></span>
          <span class="auth-home-link__text">
            <span class="auth-home-link__label">Conta</span>
            <span class="auth-home-link__value">{{$lang["login_layout_logout"]}}</span>
          </span>
        </a>
      ...
      @else
        <a class="auth-home-link" href="{{url('/')}}">
          <span class="auth-home-link__icon"><i class="fas fa-arrow-left"></i></span>
          <span class="auth-home-link__text">
            <span class="auth-home-link__label">Voltar</span>
            <span class="auth-home-link__value">{{$lang["login_layout_home"]}}</span>
          </span>
        </a>
        <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
          <div class="navbar-collapse-header">
