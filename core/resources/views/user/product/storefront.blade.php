            ...
            <div class="tab-pane fade @if(route('user.storefront')==url()->current())show active @endif" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-5 text-left">
                        <a data-toggle="modal" data-target="#new-store" href="" class="btn btn-sm btn-neutral btn-modern"><i class="fad fa-plus"></i> {{$lang["product_storefront_new_store_front"]}}</a>                 
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">  
                            @if(count($store)>0)
                                @foreach($store as $k=>$val)
                                    <div class="col-md-4">
                                        <div class="card product-card modern-card">
                                        <!-- Card body -->
                                        <div class="card-body">
                                            <div class="product-card-header">
                                            <div class="">
                                                <p class="mb-2"><a class="btn-icon-clipboard" data-clipboard-text="{{route('store.link', ['id' => $val->store_url])}}" title="{{$lang["product_storefront_copy"]}}"><i class="fad fa-link"></i> {{$lang["product_storefront_copy_link"]}}</a></p>
                                            </div>  
                                            <div class="">
                                                <a class="mr-0 text-dark icon-hover" data-toggle="dropdown" aria-haspopup="true" aria-expanded="fadse">
                                            ...
                                            <div class="">
                                            <div class="">
                                                <h4 class="product-name">{{$val->store_name}}</h4>
                                                <div class="product-stats">
                                                    <div class="product-stat">
                                                        <span class="product-stat-label">{{$lang["product_storefront_category"]}}</span>
                                                        <span class="product-stat-value">{{$val->category}}</span>
                                                    </div>
                                                    <div class="product-stat">
                                                        <span class="product-stat-label">{{$lang["product_storefront_revenue"]}}</span>
                                                        <span class="product-stat-value">{{$currency->name.' '.$val->revenue}}</span>
                                                    </div>
                                                </div>
                                                <p class="text-sm mb-3">{{$lang["product_storefront_date"]}}: {{date("h:i:A j, M Y", strtotime($val->created_at))}}</p>
                                                @if($val->status==1)
                                                    <span class="badge badge-modern badge-success-modern"><i class="fad fa-check"></i> {{$lang["product_storefront_active"]}}</span>
                                                @else
                                                    <span class="badge badge-modern badge-danger-modern"><i class="fad fa-ban"></i> {{$lang["product_storefront_disabled"]}}</span>
                                                @endif
                                            </div>
                                            </div>
                                        </div>
                            ...
                            @else
                                <div class="col-md-12 mb-5">
                                    <div class="empty-state">
                                        ...
                                        <h3 class="empty-state-title">{{$lang["product_storefront_no_storefront_found"]}}</h3>
                                        <p class="empty-state-text">{{$lang["product_storefront_we_couldnt_find_any_tore_front"]}}</p>
                                    </div>
                                </div>
                            @endif
                        </div> 
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{route('submit.product')}}" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group row">
                                <label class="col-form-label col-lg-12">Descrição</label>
                                <div class="col-lg-12">
                                  <textarea name="description" class="form-control" rows="3" placeholder="Descrição do produto (ex: conteúdo, vantagens, etc.)"></textarea>
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <label class="col-form-label col-lg-12">Preço Promocional</label>
                                <div class="col-lg-12">
                                  <div class="input-group">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text">{{$currency->symbol}}</span>
                                    </div>
                                    <input type="number" step="any" name="price_promo" class="form-control" placeholder="Opcional">
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <label class="col-form-label col-lg-12">Tipo de Pagamento</label>
                                <div class="col-lg-12">
                              ...
                              <div class="form-group row">
                                <label class="col-form-label col-lg-12">Tipo de Entrega</label>
                                <div class="col-lg-12">
                                  <select class="form-control custom-select" name="delivery_type" required>
                                    <option value="">Selecione o tipo</option>
                                    <option value="digital">Produto Digital / Download</option>
                              ...
                              <div class="form-group row">
                                <label class="col-form-label col-lg-12">Link Externo (ex: drive, site, etc.)</label>
                                <div class="col-lg-12">
                              ...
                              <div class="form-group row">
                                <label class="col-form-label col-lg-12">Tags / Palavras-chave</label>
                                <div class="col-lg-12">
                                  <input type="text" name="tags" class="form-control" placeholder="ex: ebook, receitas, vendas">
                                </div>
                              </div>
                  ...
                  <div class="col-md-12">
                    <ul class="nav nav-pills nav-justified mb-4" id="productTabs" role="tablist">
                      <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="meus-produtos-tab" data-toggle="tab" href="#meus-produtos" role="tab" aria-controls="meus-produtos" aria-selected="true">
                          Meus Produtos
                        </a>
                      </li>
                      <li class="nav-item" role="presentation">
                        <a class="nav-link" id="co-producoes-tab" data-toggle="tab" href="#co-producoes" role="tab" aria-controls="co-producoes" aria-selected="false">
                          Minhas Co-produções
                        </a>
                      </li>
                      <li class="nav-item" role="presentation">
                        <a class="nav-link" id="afiliacoes-tab" data-toggle="tab" href="#afiliacoes" role="tab" aria-controls="afiliacoes" aria-selected="false">
                          Minhas Afiliações
                        </a>
                      </li>
                    </ul>
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($product as $val)
                                  <tr class="text-dark">
                                    <td>
                                      ...
                                      <small>ID: {{ $val->ref_id }}</small>
                                    </td>
                                    <td>{{ $val->sold }}/{{ $val->quantity }}</td>
                                    <td>
                                      @if($val->status == 1)
                                    ...
                                    <td>
                                      <small class="text-xs">{{ route('user.ask', ['id' => $val->ref_id]) }}</small><br>
                                      <button class="btn btn-sm btn-outline-secondary btn-icon-clipboard mt-1"
                                              data-clipboard-text="{{ route('user.ask', ['id' => $val->ref_id]) }}">
                                        <i class="fad fa-link"></i> Copiar
                                      </button>
                                    </td>
                                    <td>
                                      <div class="btn-group" role="group">
                                        <a href="{{ route('edit.product', ['id' => $val->ref_id]) }}" class="btn btn-sm btn-primary"><i class="bi bi-pencil"></i></a>
                                        <a href="{{ route('orders', ['id' => $val->id]) }}" class="btn btn-sm btn-info"><i class="bi bi-arrow-repeat"></i></a>
                                        <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete{{ $val->id }}"><i class="bi bi-trash3"></i></button>
                                      </div>

                                      <!-- Modal exclusão -->
                                      <div class="modal fade" id="delete{{ $val->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                              Tem certeza que deseja excluir o produto <strong>{{ $val->name }}</strong>?
                                            </div>
                                            <div class="modal-footer">
                                              <a href="{{ route('delete.product', ['id' => $val->id]) }}" class="btn btn-danger">Confirmar</a>
                          ...
                          @else
                            <div class="text-center my-5">
                              ...
                              <h4 class="text-dark mt-3">{{ $lang["product_storefront_no_product_found"] }}</h4>
                              <p class="text-dark text-sm">{{ $lang["product_storefront_we_couldnt_find_any_product"] }}</p>
                            </div>
                          @endif
                        </div>
                      </div>

                      {{-- Aba: Minhas Co-produções --}}
                      <div class="tab-pane fade" id="co-producoes" role="tabpanel" aria-labelledby="co-producoes-tab">
                        <div class="text-center py-5">
                          <div class="mb-3">
                            <img src="{{ url('/') }}/asset/images/empty.svg" alt="empty">
                          </div>
                          <h4 class="text-dark">{{ $lang["product_storefront_no_orders"] }}</h4>
                          <p class="text-dark text-sm">{{ $lang["product_storefront_we_couldnt_find_any_product_order"] }}</p>
                        </div>
                      </div>

                      {{-- Aba: Minhas Afiliações --}}
                      <div class="tab-pane fade" id="afiliacoes" role="tabpanel" aria-labelledby="afiliacoes-tab">
                        <div class="text-center py-5">
                          <p>Em breve suas afiliações aparecerão aqui.</p>
                        </div>
                      </div>
                    </div>
                  </div>
