    ...
    <div class="content-wrapper">
        <div class="panel-page-stack">
            <div class="panel-page-hero">
                <span class="panel-page-hero__eyebrow"><i data-lucide="receipt" style="width: 14px; height: 14px;"></i> Central de transacoes</span>
                <h1 class="panel-page-hero__title">Acompanhe todos os fluxos de recebimento e movimentacao em uma visao consolidada.</h1>
                <p class="panel-page-hero__copy">Use as abas para separar single charge, donations, invoices, deposits, bank transfer e website checkout. Essa organizacao ajuda a investigar chargebacks, confirmar credito, comparar canais e identificar gargalos com mais rapidez.</p>
            </div>

            <div class="panel-note">
                <i data-lucide="filter" style="width: 18px; height: 18px;"></i>
                <div>
                    <strong>Como ler as tabelas.</strong>
                    <p>Priorize status, valor liquido, taxa e datas de atualizacao. Se estiver conciliando operacao, compare o tipo da transacao com o canal de origem para validar o comportamento esperado.</p>
                </div>
            </div>
