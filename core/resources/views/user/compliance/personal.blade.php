    ...
    <div class="content-wrapper">
        <div class="panel-page-stack">
            <div class="panel-page-hero">
                <span class="panel-page-hero__eyebrow"><i data-lucide="badge-check" style="width: 14px; height: 14px;"></i> Compliance pessoal</span>
                <h1 class="panel-page-hero__title">Confirme sua identidade com informacoes pessoais consistentes e documentos legiveis.</h1>
                <p class="panel-page-hero__copy">Este formulario valida dados civis, contato e documentacao da pessoa responsavel pela conta. Preencher com coerencia entre cadastro e documentos reduz rejeicoes, acelera aprovacao e evita bloqueios futuros.</p>
                <div class="panel-page-hero__meta">
                    <div class="panel-page-meta-card">
                        <span>Status atual</span>
                        <strong>{{ App\Models\Compliance::STATUS_PERSONAL[$compliance->status_personal]['text'] }}</strong>
                    </div>
                    <div class="panel-page-meta-card">
                        <span>Escopo</span>
                        <strong>Identidade pessoal</strong>
                    </div>
                    <div class="panel-page-meta-card">
                        <span>Objetivo</span>
                        <strong>Liberar operacao com seguranca</strong>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-note">
                ...
                <div>
                    <strong>Antes de enviar, revise consistencia.</strong>
                    <p>Nome, CPF, data de nascimento, telefone e documentos devem refletir exatamente os dados reais do titular. Divergencias simples costumam gerar pendencia ou nova analise.</p>
                </div>
            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col col-xs-12">
                                    <div class="alert alert-danger">
                                        <div>
                                            <h4 class="mb-1">Analise reprovada</h4>
                                            <p class="mb-0">{{$compliance->personal_status_msg}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
