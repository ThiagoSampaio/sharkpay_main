  ...
  <div class="content-wrapper">
    <div class="panel-page-stack">
      <div class="panel-page-hero">
        <span class="panel-page-hero__eyebrow"><i data-lucide="file-text" style="width: 14px; height: 14px;"></i> Gestao de invoices</span>
        <h1 class="panel-page-hero__title">Crie cobrancas, acompanhe vencimento e acione clientes com mais contexto.</h1>
        <p class="panel-page-hero__copy">Esta area centraliza invoices emitidas, status de envio, vencimento, taxa e valor total. Use o bloco lateral para leitura financeira e os cards para agir rapido em invoices pendentes ou em atraso.</p>
        <div class="panel-page-hero__actions">
          <a href="{{route('user.add-invoice')}}" class="btn btn-neutral"><i class="fad fa-plus"></i> {{$lang["invoice_create_an_invoice"]}}</a>
        </div>
        <div class="panel-page-hero__meta">
          <div class="panel-page-meta-card">
            <span>Invoices listadas</span>
            <strong>{{ count($invoice) }}</strong>
          </div>
          <div class="panel-page-meta-card">
            <span>Recebido</span>
          ...
          <div class="panel-page-meta-card">
            <span>Pendente</span>
            <strong>{{$currency->name}} {{number_format($pending, 2, '.', '')}}</strong>
          </div>
        </div>
      </div>
    <div class="row">  
                  ...
                  <div class="card-body">
                    ...
                    <div class="row align-items-center">
                      <div class="col">
                        ...
                        <p>{{$lang["invoice_sent"]}}: @if($val->sent==1) Enviado em {{$val->sent_date}} @elseif($val->sent==0) Nao enviado @endif</p>
