        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-8 m-15px-tb">
                    ...
                    <h1 class="legal-title m-25px-b">{{$lang['terms_terms_and_conditions']}}</h1>
                    <p class="legal-copy m-0px">Documento apresentado dentro do mesmo padrão institucional do restante do site, com leitura mais clara e acabamento visual consistente.</p>
                </div>
            </div>
        </div>
    </section>
